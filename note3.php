...
<body class="yellow-50">
	...
	<div class="shopnoteWrap" id="app">
		...
		<ul class="shopnote-catList flex-container">
			...
			<li class="current"><a href="note3.php">
		...
		<div class="article-area">
			<div class="flag"><img src="images/shopnote-flag-3.svg"></div>

			<ul class="noteList">
				<li>
					<div class="title">產品消費0~1999元：運費150元</div>
					<!-- <div class="content">
				...
				<li>
					<div class="title">產品消費2000元~4999元：運費190元</div>
					<!-- <div class="content">
				...
				<li>
					<div class="title">產品消費滿5000元以上即免運費</div>
					<div class="content">
						（免運費方案恕不得與其他優惠合併使用。若有大量訂購需求，<br>
						請來電04-23012180洽詢，謝謝！）
					</div>
				</li>
			</ul>
