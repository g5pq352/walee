						...
						<li class="grid-x" data-where="2">
							...
							<div class="content-area cell auto">
								...
								<div class="content">
									...
									<br>
									※依據消費者保護法第19條第1項規定：「通訊交易或訪問交易之消費者，得於收受商品或接受服務後7日內，以退回商品或書面通知方式解除契約，無須說明理由及負擔任何費用或對價。」<br>
									<br>
									倘若使用後有因產品本身瑕疵所造成的使用問題，都可以在期間內連繫我們進行處理。我們會評估是否可以為您進行產品更換。但若是評估為使用不當所造成的損壞，我們將無法為您進行更換，希望您能諒解，感謝您的配合
								</div>
							</div>
						</li>
