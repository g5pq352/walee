...
<body>
	...
	<div class="memberWrap grid-x">
		...
		<div class="setting-finish-innerWrap cell large-auto grid-x">
            <div class="deco"><img src="images/setting-finish-deco.png"></div>
            <div class="article-area">
                <div class="head-area show-for-large">
                    <div class="ch">設定完成</div>
                    <div class="en">SETUP COMPLETE</div>
                </div>
				<div class="head-area-mobile hide-for-large">
					<div class="ch">設定完成</div>
					<div class="en">SETUP COMPLETE</div>
				</div>

                <div class="btn-area"><a href="record.php">
                    <div class="arrow-go">
                        <div class="grid-x align-center-middle">
                            <div class="title">觀看訂單列表</div>
