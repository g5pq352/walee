	...
	<div class="memberWrap grid-x">
		...
		<div class="setting-innerWrap cell large-auto">
            <div class="head-area text-center show-for-large">
                <div class="en">MONTHLY FEE SETTING</div>
            ...
            <form action="monthly-fee-setting-finish.php">
                <div class="setting-itemsWrap">
                    <section>
                        <div class="item grid-x align-middle">
                            <div class="title cell shrink">寶寶名稱 / 暱稱</div>
                            <input type="text" class="cell auto">
                        </div>
                        <div class="item grid-x align-middle">
                            <div class="title cell shrink">出生 / 預產年月</div>
                            <input type="date" class="cell auto">
                        </div>
                        <div class="item grid-x align-middle">
		...
		<div class="confirm-fancyContainer">
			...
			<div class="innerWrap">
                ...
                <div class="confirm-btn">
                    ...
                    <div class="grid-x align-center-middle confirm-close">否</div>
                </div>
			</div>
		</div>
	</div>
