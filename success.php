...
<body class="is-yellow">
	...
	<div class="successWrap">
		<div class="innerWrap">
			<div class="head">
				<div class="ch">註冊成功</div>
				<div class="en">REGISTRATION SUCCESS</div>
			</div>
            ...
            <div class="container">
                ...
                <div class="content">
                    誠摯感謝您加入娃力會員!<br>
                    如有任何疑問請先瀏覽FQA 頁面<br>
                    加入LINE@ 即時訊息回覆或發e-mail到<br>
                    memberservice@creeb.co 詢問<br>
                </div>
                <div class="add"><a href="javascript:;"><img src="images/add-line.svg"></a></div>
            </div>

            <div class="note text-center">想要立即下單, 請點選前往訂單按鈕</div>

            <div class="text-center">
                <div class="arrow-go"><a href="confirm.php">
                    <div class="grid-x align-center-middle">
                        <div class="title">前往訂單</div>
