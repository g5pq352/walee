...
<body class="is-yellow">
	...
	<div class="stepWrap">
		<img src="images/step-3.svg" class="show-for-large">
		<img src="images/step-3-mobile.svg" class="hide-for-large">
	</div>

	<div class="finishWrap">
		<div class="head">林很好  您好</div>
		<div class="content">
			您的訂單已初步建立完成!<br>
			如欲立即設定月費, <br class="hide-for-large">請點選下方按鈕至月費設定頁面<br>
			任何時候登入會員中心皆可查詢訂單與月費明細<br>
			祝您有美好的一天 ：）
		</div>

		<div class="btn-area grid-x align-center">
			<div class="arrow-go"><a href="record.php">
